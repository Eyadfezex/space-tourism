      ...
      <div className="flex justify-center mt-10">
        <div className="flex flex-col items-center">
          <div className="text-center">
            <h1 className="  gap-5 text-white uppercase Hxs ">
              ...
              <ul className="flex item-center justify-center gap-8">
                {crewData.map((item) => (
                  <li
                    ...
                    className={`w-[10px] h-[10px] rounded-full bg-[#53565e] cursor-pointer  ${item.id === crewM ? "!bg-white" : ""}`}
                  ></li>
                ))}
              </ul>
            </div>
          ...
          <div className="flex justify-center pb-10">
            <img src={crew?.img} alt={crew?.name} className="w-[80%]  mt-10" />
          </div>
        </div>
      </div>
    </main>
